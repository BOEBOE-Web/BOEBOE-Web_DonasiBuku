<?php 
      ...
      $queryDonatur = 
      "INSERT INTO `donatur_daftar` (`id_donatur`, `id_loginDonatur`, `email_donatur`, `password_donatur`, `nama_donatur`,`nomorHP_donatur`, `tanggalLahir_donatur`, `id_alamatDonatur`, `instansi_donatur`)
