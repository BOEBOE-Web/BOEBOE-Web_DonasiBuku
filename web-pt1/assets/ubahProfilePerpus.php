...
<style>
    <?php include "../css/ubahProfilePerpus.css" ?>
...
<body>
                ...
                <li>
                    <div class="dropdown">
                        ...
                        <ul style="display:unset; flex-wrap: unset;" class="dropdown-menu" aria-labelledby="navbarDarkDropdownMenuLink">
                            <li><a style="float: none;" class="dropdown-item" href="dasborPerpus.php">Dasbor</a></li>
                            <li><a style="float: none;" class="dropdown-item" href="#">Konfirmasi Donasi</a></li>
                            <li><a style="float: none;" class="dropdown-item" href="../index.php">Log Out</a></li>
                        </ul>
                    </div>
                </li>
            </ul>
    ...
    <div class="change-profile">
        ...
        <form class="row g-3 needs-validation" novalidate>
            ...
            <div class="col-12">
                <button type="submit" class="btn btn-primary col-12" onclick="document.location='dasborPerpus.php'">Simpan Perubahan</button>
            </div>
        </form>
        <!-- END FORM -->
    </div>
